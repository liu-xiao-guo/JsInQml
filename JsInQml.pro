...
UBUNTU_TRANSLATION_DOMAIN="jsinqml.liu-xiao-guo"
...
aptest.commands = bash $$PWD/JsInQml/tests/autopilot/run
aptest.depends  = sub-JsInQml

unittest.target   = check
unittest.commands = /usr/bin/qmltestrunner -input $$PWD/JsInQml/tests/unit 
unittest.depends  = sub-JsInQml
